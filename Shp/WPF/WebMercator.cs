...
namespace Shp.WPF
{
    ...
    public static class WebMercator
    {
        ...
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bounds GetTileBounds(int tileX, int tileY, int zoomLevel)
        {
            return new Bounds(
        ...
        public static GeographicalBounds GetTileGeographicalBounds(int tileX, int tileY, int zoomLevel)
        {
            return new GeographicalBounds(
                new GeographicalPoint(PixelXToLongitude(TileSize * tileX, zoomLevel), PixelYToLatitude(TileSize * tileY + TileSize, zoomLevel)),
                new GeographicalPoint(PixelXToLongitude(TileSize * tileX + TileSize, zoomLevel), PixelYToLatitude(TileSize * tileY, zoomLevel)));
        }
